...
let s1, s2, s3, s4, s5, s6, s7, s8, t1, t2, t3, t4, t5, t6, t7, t8;
...
function setup() {
  ...
  s5 = createSliderV("Slider 1", 425, 25, 75, 350);
  s6 = createSliderV("Slider 2", 525, 25, 75, 350);
  s7 = createSliderV("Slider 3", 625, 25, 75, 350);
  s8 = createSliderV("Slider 4", 725, 25, 75, 350);
  ...
  t5 = createToggle("M", 425, 400, 75, 75);
  t6 = createToggle("M", 525, 400, 75, 75);
  t7 = createToggle("M", 625, 400, 75, 75);
  t8 = createToggle("M", 725, 400, 75, 75);
  ...
  //// OBJECT STYLE SETTINGS
    ...
    t5.setStyle(toggleStyle);
    t6.setStyle(toggleStyle);
    t7.setStyle(toggleStyle);
    t8.setStyle(toggleStyle);
