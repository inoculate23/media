...
Main.prototype = {
	...
	,onWindowLoaded: function() {
		...
		Main.openImageFileInput.addEventListener("change",function(e) {
            ...
            var file = startImage[0];
            var fileReader = new FileReader();
            fileReader.onload = function(e) {
                var image = function snap() {     		
...
var geometrize_runner_ImageRunner = $hx_exports["geometrize"]["runner"]["ImageRunner"] = function(myImage,backgroundColor) {
	this.model = null;
...
Main.openImageFileInput = window.document.getElementById("myCanvas");
...
Main.defaultImageElement = window.document.getElementById("myCanvas");
Main.imagesToGeometrize = "http://127.0.0.1:5503/chatsketch/bin/stripgeo.html"
