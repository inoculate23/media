...
(() => {
    ...
    function D(a) {
        ...
        y(b, 'Missing shader source: <script type="x-shader/x-fragment" id="' +
            (a + '">'));
    ...
    function E(a) {
        a += "Vertex";
        const b = document.getElementById(a);
        return b ? (B(b, "x-shader/x-vertex",
    ...
    class G {
        constructor(a, b, c, d) {
            ...
            this.i = () => {
                ...
                f = a.gl;
                for (h = 0; h < a.g; h++) f.activeTexture(f.TEXTURE0 +
                    h), f.bindTexture(f.TEXTURE_2D, null);
                a.g = 0
            }
        }
    }
    ...
    function J(a, b, c, d, l, f) {
        ...
        const p = H(a),
            ...
            g = {
                ...
                toShaderX: e => (e - a.getBoundingClientRect().left) *
                    g.cssPixelRatio + .5,
                toShaderY: e => a.height - (e - a.getBoundingClientRect().top) * g.cssPixelRatio -
                    .5,
                s: () => g.cssWidth !== a.clientWidth || g.cssHeight !== a.clientHeight ? (g.resize(), !0) :
                    !1,
                resize: () => {
        ...
        for (const e in b) {
            ...
            const m = N(p, h(e, E(e), D(e)), g.buffers[e]),
                n = b[e].uniforms || {};
            var u = Object.keys(n);
            for (const k of m.m) y(n[k.name], 'No configuration for uniform "' +
                k.name + '" defined in shader "' + e + '"'), u = u.filter(r => r !== k.name);
            0 !== u.length && console.warn('Extra uniforms configured for shader "' +
    ...
    shaderWebBackground.shade = function(a) {
        ...
        try {
            const c = J(b, a.shaders,
                a.onInit, a.onResize, a.onBeforeFrame, a.onAfterFrame);
    ...
    class W extends U {
        ...
        g(a,
            b) {
            const c = this.gl;
            c.texImage2D(c.TEXTURE_2D, 0, c.RGBA16F, a, b, 0, c.RGBA, c.HALF_FLOAT,
                null)
        }
    }
    ...
    function N(a, b, c) {
        ...
        for (let f = 0; f < l; f++) {
            ...
            a.push({
                name: h.name,
                location: d.getUniformLocation(b,
                    h.name)
            })
        }
        return {
    ...
    class I {
        constructor(a, b) {
            ...
            else if (d = a.getContext("webgl",
                    b)) this.h = new V(d, c);
            c(d, "webgl context not supported on supplied canvas element: " +
                a);
            this.gl = d;
            a = d.createBuffer();
            d.bindBuffer(d.ARRAY_BUFFER, a);
            d.bufferData(d.ARRAY_BUFFER,
                new Float32Array(O), d.STATIC_DRAW);
    ...
    class L {
        ...
        i(a) {
            ...
            b.bindFramebuffer(b.FRAMEBUFFER,
                this.j);
            b.framebufferTexture2D(b.FRAMEBUFFER, b.COLOR_ATTACHMENT0, b.TEXTURE_2D, this.g,
                0);
            a();
            b.framebufferTexture2D(b.FRAMEBUFFER, b.COLOR_ATTACHMENT0, b.TEXTURE_2D, null,
                0);
